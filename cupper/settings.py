"""
Django settings for cupper project.
...
SECRET_KEY = 'django-insecure-s+qy(2%im18dd9_%(s6hih^(!p(qc*2zwan1%8itk7wfgbyht6'
...
WSGI_APPLICATION = 'cupper.wsgi.application'
...
DATABASES = {
    ...
    # 'default': {
	   ...
	   #  'NAME': 'cupper',
	   #  'USER' : 'cupper_admin',
	   #  'PASSWORD' : '1kHWWv5xwJbQ8rpOk56tCLxCXYS02UxV',
	   #  'HOST' : 'dpg-cv9ia2tds78s73cuk9o0-a.frankfurt-postgres.render.com',
	   #  'PORT' : '5432',
    # }
